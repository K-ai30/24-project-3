...
import imageChart from "./../../images/The-trouble-with-graphs.jpg";
        ...
        <div className="row">
          <div className="col-lg-3">
            <div className="dashboardSidebar">
              <img className="imgChart" src={imageChart} />
            </div>
          </div>
            ...
            <div className="row">
              <div className="col-lg-12">
                <h2 className="welcomeTitle">
                  Welcome to DataTrack Dashboard !
                </h2>
              </div>
              ...
              <div className="col-lg-4">
                <Link className="dashboardmenu" to="/reports">
                  <span>Reports</span>
