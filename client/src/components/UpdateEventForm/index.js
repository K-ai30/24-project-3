...
class UpdateEventForm extends Component {
    ...
    handleSubmit(event, communityID){
        ...
        Axios({
            method: 'put',     //put
            url: `/api/event/${this.props.match.params.id}`,
 ...
 render() {
     ...
     return (
         <form className="wrapper mx-auto align-middle">
            ...
            <button id="submitResident" className="btn btn-info custom-color" onClick={(event)=> this.handleSubmit(event)}>Update Event</button>
        </form>
     )
  }
}
