    ...
    return (
      <form className="wrapper mx-auto align-middle">
        <div className="addEventform">
          <h1 className="eventTitle">Add Event</h1>
        </div>
        <Row>
          <Col>
          ...
          <Col>
            <TextInput
              id="eventName"
              placeholder="Senior Yoga Class"
              labelText="Even Name"
            />
            <TextInput
              id="evendate"
              placeholder="05/02/2020"
        ...
        <Row>
          <Col>
            ...
            <textarea
              ...
              placeholder="Low-impact yoga for senior"
            ></textarea>
          </Col>
        </Row>
        <button id="submitResident" className="btn btn-info custom-color">
          + Add Event
        </button>
      </form>
    );
